from app.config import generate_authoritative_schema
...
def run_rag_pipeline() -> None:
    authoritative_schema = generate_authoritative_schema()

    while True:
        question: str = input("Enter your question: ")
        docs: str = retrieve_schema_docs(question)

        sql_query: str = generate_sql(question, docs, authoritative_schema)
        print("\nGenerated SQL Query:\n")
        print(sql_query)
